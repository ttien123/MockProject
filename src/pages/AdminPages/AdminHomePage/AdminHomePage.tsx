...
const AdminHomePage = () => {
    ...
    useEffect(() => {
        const newListAccount = listAccount.filter((e) =>
        ...
        <div className="bg-[#222433] min-h-screen lg:h-screen text-[#333]">
            <div className="pt-[105px] h-full ">
                <div className="containerCst h-full pt-4 lg:pt-10 text-white flex flex-col">
                    <div className="flex items-start lg:items-center justify-between lg:h-[40px] flex-col lg:flex-row">
                        <div className="text-[20px] font-semibold mb-2 lg:mb-0">Danh sách thành viên</div>
                        <div className="flex items-start lg:items-center justify-between w-full lg:w-[500px] h-full gap-3 flex-col lg:flex-row">
                            <InputSearchTable />
